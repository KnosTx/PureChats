...
use _64FF00\PureChat\clans\ClansInterface;
    ...
    */
    ...
    public function applyPCTags($string, Player $player, $message, $levelName)
    {
        ...
        if ($this->clanAPI !== null) {
            $string = str_replace("{clan_name}", $this->clanAPI->getPlayerClanName($player), $string);
            $string = str_replace("{clan_display_name}", $this->clanAPI->getPlayerClanDisplayName($player), $string);
            $string = str_replace("{clan_rank}", $this->clanAPI->getPlayerRank($player), $string);
        } else {
            $string = str_replace("{clan_name}", '', $string);
            $string = str_replace("{clan_display_name}", '', $string);
